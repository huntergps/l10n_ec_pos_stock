...
import { LowStockLine } from "@l10n_ec_pos_stock/app/screens/product_screen/product_low_stock_screen/low_stock_line/low_stock_line";

export class LowStockProducts extends Component {
    static components = { LowStockLine };
    static template = "l10n_ec_pos_stock.LowStockProducts";
